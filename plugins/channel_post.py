...
async def channel_post(client: Client, message: Message):
    reply_text = await message.reply_text("𝐓𝐔𝐍𝐆𝐆𝐔 𝐒𝐄𝐁𝐄𝐍𝐓𝐀𝐑 ...", quote = True)
    try:
        ...
        print(e)
        await reply_text.edit_text("𝐀𝐃𝐀 𝐘𝐀𝐍𝐆 𝐒𝐀𝐋𝐀𝐇, 𝐌𝐎𝐇𝐎𝐍 𝐔𝐋𝐀𝐍𝐆𝐈 ...!")
        return
    ...
    await reply_text.edit(f"<b>INI LINK FILEMU</b>\n\n{link}", reply_markup=reply_markup, disable_web_page_preview = True)
